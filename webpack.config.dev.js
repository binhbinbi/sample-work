...
module.exports = {
  ...
  module: {
    loaders: [
      ...
      { test: /\.png|jpg(\?v=\d+\.\d+\.\d+)*$/, loader: 'url?limit=10000' },
      { test: /\.ttf(\?v=\d+\.\d+\.\d+)*$/, loader: 'url?limit=10000&mimetype=image/svg+xml' },
      { test: /\.(woff|woff2)(\?v=\d+\.\d+\.\d+)*$/, loader: 'url?prefix=font/&limt=5000' }
    ]
  }
};
